...
<div class="bg-body-dark">
   <div class="content">
      <div class="row">
         ...
         <div class="col-6 col-md-4 col-xl-2">
            <a class="block block-rounded text-center" href="/schema-detail">
               <div class="block-content">
                  <p class="mt-5 mb-10">
                  ...
                  <p class="font-w600 font-size-sm text-uppercase">Schema Det.</p>
               </div>
            </a>
