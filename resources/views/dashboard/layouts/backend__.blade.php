                  ...
                  <ul class="nav-main">
                     ...
                     <li>
                        <a href="{{route('schema-master.index')}}">
                           <i class="si si-users fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Schema Master</span>
                        </a>
                     </li>

                     <li>
                        <a href="{{route('schema-detail.index')}}">
                           <i class="fa fa-money fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Schema Detail</span>
                        </a>
                     </li>

                     <li>
                        <a href="{{route('payment.index')}}">
                           <i class="si si-bar-chart fa-3x"></i><span class="sidebar-mini-hide">Payment</span>
                        </a>
                     </li>

                     <li>
                        <a href="/payables">
                           <i class="si si-bar-chart fa-3x"></i><span class="sidebar-mini-hide">Payables</span>
                        </a>
                     </li>

                     <li>
                        <a href="/admissions">
                           <i class="si si-users fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Admission </span>
                        </a>
                     </li>
                     ...
                     <li>
                        <a href="/technology">
                           <i class="si si-users fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Technology </span>
                        </a>
                     </li>

                     <li>
                        <a href="/semesters">
                           <i class="si si-users fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Semester </span>
                        </a>
                     </li>

                     <li>
                        <a href="/sessions">
                           <i class="si si-users fa-3x text-body-bg-dark"></i><span class="sidebar-mini-hide">Session </span>
                        </a>
                     </li>
