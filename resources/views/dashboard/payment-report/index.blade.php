            ...
            <div class="col-xl-8 mx-auto">
               <div class="block block-themed">
                  <div class="block-header bg-default">
                     <h3 class="block-title">Payment Detail - Student</h3>
                    ...
                    <div class="block-content">
                        <form action="{{route('payment-report.show','single')}}">

                           <div class="row">
                               <div class="col-6">
                                   <div class="form-group">
                                       <div class="form-material floating">
                                           <input type="number" class="form-control" id="roll" autofocus name="roll">
